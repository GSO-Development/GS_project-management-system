...
<div class="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4 sm:p-6 md:p-10 font-sans relative overflow-hidden" style="background: radial-gradient(circle at 50% 0%, #ffffff 0%, #f1f5f9 100%);">
    ...
    <div class="w-full max-w-md z-10">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Create New Password</h1>
            <p class="text-xs text-slate-500 font-medium mt-2 leading-relaxed max-w-sm mx-auto">
                Please choose a new secure password for your executive workspace account.
            </p>
        </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200/90 shadow-2xl shadow-slate-300/60 p-6 sm:p-8 relative">
            ...
            <form method="POST" action="{{ route('password.store') }}" x-data="{ showPassword: false, loading: false }" @submit="loading = true" class="space-y-4">
                @csrf
                ...
                <!-- New Password -->
                <div>
                    <label for="password" class="block text-xs font-extrabold text-slate-800 mb-1.5">New Password <span class="text-rose-500">*</span></label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                            <svg class="w-4 h-4 text-slate-400" width="16" height="16" style="width: 16px; height: 16px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block text-xs font-extrabold text-slate-800 mb-1.5">Confirm New Password <span class="text-rose-500">*</span></label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
                            <svg class="w-4 h-4 text-slate-400" width="16" height="16" style="width: 16px; height: 16px;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                    type="submit"
                    :disabled="loading"
                    class="w-full py-3.5 px-4 rounded-xl text-xs font-black text-white bg-gradient-to-r from-[#c3122e] to-[#9a091d] hover:from-[#a50d24] hover:to-[#800617] shadow-lg shadow-[#c3122e]/30 transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99] pt-2"
                >
