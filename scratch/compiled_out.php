<div class="space-y-6 pt-1">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('error_message')): ?>
        <div class="p-4 rounded-2xl bg-rose-50 border border-rose-200 text-[#c3122e] text-xs font-bold flex items-center justify-between shadow-xs animate-in fade-in duration-200">
            <div class="flex items-center gap-2">
                <span class="text-base">❌</span>
                <span><?php echo e(session('error_message')); ?></span>
            </div>
    ...
    <div class="relative overflow-hidden rounded-3xl border border-rose-950/40 shadow-xl p-5 sm:p-7 text-white" style="background: linear-gradient(135deg, #15060b 0%, #260812 50%, #15060b 100%);">
        ...
        <div class="absolute right-0 top-0 bottom-0 w-full sm:w-2/3 lg:w-1/2 pointer-events-none opacity-25 overflow-hidden flex items-center justify-end">
            <img src="<?php echo e(asset('images/project-banner-dark.jpg')); ?>" alt="Skyline" class="h-full w-full object-cover object-right" style="-webkit-mask-image: linear-gradient(to right, transparent 0%, black 60%); mask-image: linear-gradient(to right, transparent 0%, black 60%);">
        </div>
                ...
                <div class="overflow-x-auto scrollbar-none max-w-full pb-1 sm:pb-0" style="scrollbar-width: none;">
                    <div class="inline-flex p-1 rounded-xl border border-white/15 shadow-xl backdrop-blur-xl flex-nowrap min-w-max" style="background: rgba(0, 0, 0, 0.45);">
                        <button 
                            ...
                            type="button" 
                            class="px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 <?php echo e($viewMode === 'table' ? 'bg-white text-slate-900 shadow-md scale-[1.02]' : 'text-slate-200 hover:text-white hover:bg-white/10'); ?>"
                        ...
                        <button 
                            ...
                            type="button" 
                            class="px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 <?php echo e($viewMode === 'gantt' ? 'bg-white text-amber-900 shadow-md scale-[1.02]' : 'text-slate-200 hover:text-white hover:bg-white/10'); ?>"
                        ...
                        <button 
                            ...
                            type="button" 
                            class="px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 <?php echo e($viewMode === 'stuck' ? 'bg-[#c3122e] text-white shadow-md scale-[1.02]' : 'text-rose-300 hover:text-white hover:bg-rose-900/40'); ?>"
                            title="Live Stuck & Blocked Tasks Radar"
                        >
                            <span class="w-2 h-2 rounded-full bg-rose-400 <?php echo e($totalStuckTasksCount > 0 ? 'animate-pulse' : ''); ?>"></span>
                            <span>Stuck Tasks</span>
                            <span class="px-1.5 py-0.2 rounded-md text-[10px] font-mono bg-white/20 text-white"><?php echo e($totalStuckTasksCount); ?></span>
                        </button>
                    </div>
                </div>
    ...
    <!-- ═══════════════════════════════════════════════════════════════
         ...
         ═══════════════════════════════════════════════════════════════ -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode === 'matrix' || $viewMode === 'table'): ?>
        <style>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 kpi-5-grid gap-3.5 sm:gap-4">
            ...
            <button type="button" wire:click="setQuickSegment('all'); $set('healthFilter', 'all'); $set('statusFilter', 'all')"
                    class="bg-white rounded-2xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-4 text-left transition-all duration-200 cursor-pointer hover:shadow-md hover:-translate-y-0.5
                           <?php echo e($quickSegment === 'all' && $healthFilter === 'all' && $statusFilter === 'all' ? 'border-blue-400 shadow-sm' : 'hover:border-slate-300'); ?>">
                ...
                <div>
                    <div class="text-2xl sm:text-3xl font-bold font-mono text-slate-800 leading-tight tracking-tight"><?php echo e($totalProjectsCount); ?></div>
            ...
            <button type="button" wire:click="setQuickSegment('on_track'); $set('statusFilter', 'all')"
                    class="bg-white rounded-2xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-4 text-left transition-all duration-200 cursor-pointer hover:shadow-md hover:-translate-y-0.5
                           <?php echo e($quickSegment === 'on_track' ? 'border-emerald-400 shadow-sm' : 'hover:border-slate-300'); ?>">
                ...
                <div>
                    <div class="text-2xl sm:text-3xl font-bold font-mono text-slate-800 leading-tight tracking-tight"><?php echo e($onTrackCount); ?></div>
            ...
            <button type="button" wire:click="setQuickSegment('critical'); $set('statusFilter', 'all')"
                    class="bg-white rounded-2xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-4 text-left transition-all duration-200 cursor-pointer hover:shadow-md hover:-translate-y-0.5
                           <?php echo e($quickSegment === 'critical' ? 'border-amber-400 shadow-sm' : 'hover:border-slate-300'); ?>">
                ...
                <div>
                    <div class="text-2xl sm:text-3xl font-bold font-mono text-slate-800 leading-tight tracking-tight"><?php echo e($delayedCount); ?></div>
            ...
            <button type="button" wire:click="setQuickSegment('at_risk'); $set('statusFilter', 'all')"
                    class="bg-white rounded-2xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-4 text-left transition-all duration-200 cursor-pointer hover:shadow-md hover:-translate-y-0.5
                           <?php echo e($quickSegment === 'at_risk' ? 'border-rose-400 shadow-sm' : 'hover:border-slate-300'); ?>">
                ...
                <div>
                    <div class="text-2xl sm:text-3xl font-bold font-mono text-slate-800 leading-tight tracking-tight"><?php echo e($atRiskOrBlockedCount); ?></div>
            ...
            <button type="button" wire:click="$set('statusFilter', 'on_hold'); setQuickSegment('all')"
                    class="bg-white rounded-2xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-4 text-left transition-all duration-200 cursor-pointer hover:shadow-md hover:-translate-y-0.5
                           <?php echo e($statusFilter === 'on_hold' ? 'border-purple-400 shadow-sm' : 'hover:border-slate-300'); ?>">
                ...
                <div>
                    <div class="text-2xl sm:text-3xl font-bold font-mono text-slate-800 leading-tight tracking-tight"><?php echo e($onHoldCount); ?></div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 p-3 sm:p-3.5 shadow-2xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2.5 flex-wrap sm:flex-nowrap">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $statusFilter !== 'all' || $priorityFilter !== 'all' || $healthFilter !== 'all' || $pmFilter !== 'all' || $subsidiaryFilter !== 'all'): ?>
    ...
    <!-- ═══════════════════════════════════════════════════════════
         ...
         ═══════════════════════════════════════════════════════════ -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode === 'matrix'): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $paginatedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php
                ...
                <div class="bg-white rounded-2xl border <?php echo e($hColor['cardBorder']); ?> shadow-sm hover:shadow-lg transition-all duration-200 flex flex-col overflow-hidden group">
                    
                    <!-- ── Colored accent top stripe ── -->
                    <div class="h-1 w-full" style="background: <?php echo e($hColor['accent']); ?>;"></div>
                    ...
                    <div class="p-4 sm:p-5 space-y-4 flex-1">
                        ...
                        <div class="flex items-center justify-between gap-2">
                            ...
                            <div class="flex items-center gap-1.5">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-black border <?php echo e($hColor['bg']); ?> <?php echo e($hColor['text']); ?> <?php echo e($hColor['border']); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full <?php echo e($hColor['dot']); ?> <?php echo e($project->computed_health === 'delayed' ? 'animate-pulse' : ''); ?>"></span>
                                    <?php echo e($hColor['label']); ?>

                                </span>
                                <span class="px-2 py-0.5 rounded text-[9.5px] font-black uppercase <?php echo e($priorityStyle); ?>">
                                    <?php echo e($project->priority->value ?? 'medium'); ?>
                        ...
                        <div>
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">
                                <?php echo e($project->subsidiary->name ?? 'George Steuart Group'); ?>
                        ...
                        <div class="flex items-center justify-between gap-2">
                            <div class="flex items-center gap-2 min-w-0">
                                <div class="w-7 h-7 rounded-full bg-slate-900 text-white font-bold text-[11px] flex items-center justify-center flex-shrink-0 shadow-sm">
                                    <?php echo e(strtoupper(substr($project->projectManager->name ?? 'U', 0, 1))); ?>

                                </div>
                                <span class="text-[11px] font-bold text-slate-700 truncate">
                                    <?php echo e($project->projectManager->name ?? 'Unassigned'); ?>

                                </span>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pmAccepted): ?>
                            ...
                            <?php elseif($pmRejected): ?>
                                <span class="inline-flex items-center gap-1 text-[9.5px] font-black text-rose-700 bg-rose-50 border border-rose-200 px-2 py-0.5 rounded-md flex-shrink-0" title="<?php echo e($project->pm_rejection_reason); ?>">
                                    ✕ Rejected
                                </span>
                            <?php else: ?>
                        ...
                        <div class="space-y-1.5">
                            <div class="flex items-center justify-between text-[11px]">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="font-black text-slate-900 font-mono"><?php echo e($project->overall_progress); ?>%</span>
                                    <span class="font-mono text-[10px] <?php echo e($project->progress_delta < 0 ? 'text-rose-500' : 'text-emerald-600'); ?>">
                                        <?php echo e($project->progress_delta >= 0 ? '▲' : '▼'); ?><?php echo e(abs($project->progress_delta)); ?>% vs plan
                                    </span>
                                </div>
                            </div>
                            <div class="w-full <?php echo e($hColor['barBg']); ?> h-2 rounded-full overflow-hidden">
                                <div class="h-full rounded-full <?php echo e($hColor['bar']); ?> transition-all duration-500" style="width: <?php echo e(max(2, $project->overall_progress)); ?>%"></div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2 text-[11px]">
                            ...
                            <div class="bg-slate-50 rounded-xl p-2.5 border border-slate-100">
                                ...
                                <p class="font-bold text-slate-800 font-mono text-[11px]">
                                    <?php echo e($project->deadline ? $project->deadline->format('M d, Y') : '—'); ?>

                                </p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->is_past_deadline): ?>
                                    <span class="text-[9.5px] font-black text-[#c3122e]"><?php echo e(abs($project->days_remaining)); ?>d overdue</span>
                                <?php elseif($project->days_remaining !== null): ?>
                                    <span class="text-[9.5px] font-bold text-slate-500"><?php echo e($project->days_remaining); ?>d left</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            ...
                            <div class="bg-slate-50 rounded-xl p-2.5 border border-slate-100">
                                ...
                                <p class="font-black text-slate-900 font-mono text-[11px]">
                                    <?php echo e($project->completed_tasks_count); ?><span class="font-bold text-slate-400">/<?php echo e($project->total_tasks_count); ?></span>
                                </p>
                                <div class="flex items-center gap-1.5 mt-0.5">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->overdue_tasks_count > 0): ?>
                                        <span class="text-[9px] font-black text-rose-600">🚨 <?php echo e($project->overdue_tasks_count); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->blocked_tasks_count > 0): ?>
                                        <span class="text-[9px] font-black text-red-600">🛑 <?php echo e($project->blocked_tasks_count); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->overdue_tasks_count === 0 && $project->blocked_tasks_count === 0): ?>
                    ...
                    <div class="px-4 py-2.5 bg-slate-50 border-t border-slate-100 flex items-center gap-2">
                        ...
                        <button wire:click="openWbsDrawer(<?php echo e($project->id); ?>)" 
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->project_manager_id): ?>
                            <button wire:click="quickPingPm(<?php echo e($project->id); ?>)" 
                            ...
                            <button wire:click="openNudgeModal(<?php echo e($project->id); ?>)" 
                    ...
                    <tbody class="divide-y divide-slate-100/80 bg-white font-medium text-slate-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $paginatedProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <tr class="hover:bg-slate-50/60 transition-colors group cursor-pointer"
                                onclick="window.location='<?php echo e(route('projects.show', $project->id)); ?>'">
                                
                                <!-- 1. Project Name (with Left Dot Indicator) -->
                                <td class="py-4 px-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2.5">
                                        <span style="background-color: <?php echo e($isDelayed ? '#be123c' : ($isCompleted ? '#047857' : ($isPlanning ? '#94a3b8' : '#e07a1e'))); ?>;" 
                                ...
                                <td class="py-4 px-4 whitespace-nowrap">
                                    ...
                                    <?php elseif($project->status->value === 'on_hold'): ?>
                                ...
                                <td class="py-4 px-4 whitespace-nowrap text-xs">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->priority->value === 'high' || $project->priority->value === 'critical'): ?>
                                        <span style="color: #be123c;" class="font-bold text-xs">High</span>
                                    <?php elseif($project->priority->value === 'medium'): ?>
                                ...
                                <td class="py-4 px-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div style="width: 130px; height: 8px; background-color: #edebe7; border-radius: 9999px; overflow: hidden; flex-shrink: 0;">
                                            <div style="width: <?php echo e(max(4, $prog)); ?>%; height: 100%; border-radius: 9999px; background-color: <?php echo e($isDelayed ? '#be123c' : '#10b981'); ?>; transition: width 0.3s;"></div>
                                        </div>
                                        <span class="font-medium font-mono text-xs text-slate-700"><?php echo e($prog); ?>%</span>
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-4 whitespace-nowrap" onclick="event.stopPropagation()">
                                    <div class="flex items-center gap-2.5">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->projectManager?->profile_photo_url): ?>
                                            <img src="<?php echo e($project->projectManager->profile_photo_url); ?>" class="w-6 h-6 rounded-full object-cover shadow-2xs" alt="">
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <span class="font-medium text-slate-700 text-xs"><?php echo e($pmName); ?></span>
                                    </div>
                                </td>

                                <!-- 7. Timeline -->
                                <td class="py-4 px-4 whitespace-nowrap text-xs text-slate-500 font-medium">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->start_date && $project->deadline): ?>
                                        <?php echo e($project->start_date->format('d M Y')); ?> — <?php echo e($project->deadline->format('d M Y')); ?>

                                    <?php elseif($project->deadline): ?>
                                        Due <?php echo e($project->deadline->format('d M Y')); ?>
                                ...
                                <td class="py-4 px-4 text-right whitespace-nowrap" onclick="event.stopPropagation()">
                                    <div class="relative inline-block text-left" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" @click.away="open = false" x-transition
                                            ...
                                            <a href="<?php echo e(route('projects.show', $project->id)); ?>" class="w-full text-left px-3 py-2 hover:bg-slate-50 text-slate-700 font-medium flex items-center gap-2">
                                                <span>📂</span> Project Workspace
                                            </a>
                                            <button wire:click="openWbsDrawer(<?php echo e($project->id); ?>); open = false" class="w-full text-left px-3 py-2 hover:bg-slate-50 text-slate-700 font-medium flex items-center gap-2">
                                                <span>📋</span> Inspect WBS Tasks
                                            </button>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->blocked_tasks_count > 0 || $project->open_risks_count > 0): ?>
                                                <button wire:click="openBlockersModal(<?php echo e($project->id); ?>); open = false" class="w-full text-left px-3 py-2 hover:bg-rose-50 text-rose-600 font-medium flex items-center gap-2">
                                                    <span>⚠️</span> View Blockers (<?php echo e($project->blocked_tasks_count); ?>)
                                                </button>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <button wire:click="openNudgeModal(<?php echo e($project->id); ?>); open = false" class="w-full text-left px-3 py-2 hover:bg-amber-50 text-amber-700 font-medium flex items-center gap-2">
                                                <span>🔔</span> Alert PM
                                            </button>
                                        </div>
                                    </div>
    ...
    <?php elseif($viewMode === 'gantt'): ?>
        <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3.5">
                        ...
                        <div>
                            <div class="flex items-center gap-2 flex-wrap">
                                <h2 class="text-base sm:text-lg font-black text-slate-900 tracking-tight" style="font-family: 'Plus Jakarta Sans', system-ui, sans-serif;">
                                    Enterprise Multi-Project Schedule Radar
                                </h2>
                                <span class="px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-rose-50 text-[#c3122e] border border-rose-200">
                                    <?php echo e($ganttTimeframe === '3m' ? '3 Months' : ($ganttTimeframe === '12m' ? '12 Months' : ($ganttTimeframe === 'all' ? 'Full Project Span' : '6 Months'))); ?>

                                </span>
                                <span class="px-2 py-0.5 rounded-full text-[9.5px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 inline-flex items-center gap-1">
                                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                                    <span>All Projects &amp; Deliverables Live</span>
                                </span>
                            </div>
                            <p class="text-xs text-slate-500 mt-0.5 font-medium flex items-center gap-1.5 flex-wrap">
                                <span>Timeline Horizon:</span>
                                <strong class="text-slate-800 font-mono font-bold"><?php echo e($ganttTimeline['start']->format('M d, Y')); ?></strong>
                                <span class="text-slate-400">→</span>
                                <strong class="text-slate-800 font-mono font-bold"><?php echo e($ganttTimeline['end']->format('M d, Y')); ?></strong>
                                <span class="text-slate-400 font-normal">(<?php echo e($ganttTimeline['total_days']); ?> Days Span)</span>
                            </p>
                        </div>
                    </div>

                    <!-- Right Controls: Horizon Segmented Control -->
                    <div class="flex flex-wrap items-center gap-2.5">
                        <div class="inline-flex p-1 rounded-xl bg-slate-100 border border-slate-200/90 text-xs font-bold">
                            <button wire:click="setGanttTimeframe('3m')" type="button"
                                    class="px-3 py-1.5 rounded-lg transition-all cursor-pointer <?php echo e($ganttTimeframe === '3m' ? 'bg-white text-slate-900 shadow-xs font-black' : 'text-slate-500 hover:text-slate-900'); ?>"
                                    title="Quarterly View (3 Months)">
                                3M
                            </button>
                            <button wire:click="setGanttTimeframe('6m')" type="button"
                                    class="px-3 py-1.5 rounded-lg transition-all cursor-pointer <?php echo e($ganttTimeframe === '6m' ? 'bg-white text-slate-900 shadow-xs font-black' : 'text-slate-500 hover:text-slate-900'); ?>"
                                    title="Semi-Annual View (6 Months)">
                                6M
                            </button>
                            <button wire:click="setGanttTimeframe('12m')" type="button"
                                    class="px-3 py-1.5 rounded-lg transition-all cursor-pointer <?php echo e($ganttTimeframe === '12m' ? 'bg-white text-slate-900 shadow-xs font-black' : 'text-slate-500 hover:text-slate-900'); ?>"
                                    title="Annual View (12 Months)">
                                12M
                            </button>
                            <button wire:click="setGanttTimeframe('all')" type="button"
                                    class="px-3 py-1.5 rounded-lg transition-all cursor-pointer <?php echo e($ganttTimeframe === 'all' ? 'bg-white text-slate-900 shadow-xs font-black' : 'text-slate-500 hover:text-slate-900'); ?>"
                                    title="Fit to All Projects Schedule Span">
                                Fit All
                            </button>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-center justify-between gap-3 pt-1">
                    ...
                    <div class="flex flex-wrap items-center gap-2 flex-1 min-w-[280px]">
                        ...
                        <div class="relative flex-1 min-w-[180px] max-w-[260px]">
                            ...
                            <input wire:model.live.debounce.300ms="search" type="text" placeholder="Search projects or deliverables…"
                        ...
                        <select wire:model.live="subsidiaryFilter" class="custom-select px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#c3122e]/15 focus:border-[#c3122e] transition-all min-w-[140px]">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $subsidiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <select wire:model.live="pmFilter" class="custom-select px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#c3122e]/15 focus:border-[#c3122e] transition-all min-w-[130px]">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($pm->id); ?>"><?php echo e($pm->name); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $subsidiaryFilter !== 'all' || $healthFilter !== 'all' || $pmFilter !== 'all'): ?>
                    ...
                    <div class="flex items-center gap-3 text-xs font-semibold text-slate-600 flex-wrap">
                        ...
                        <span class="inline-flex items-center gap-1.5">
                            <span class="w-2.5 h-2.5 rounded-full bg-blue-600 shadow-xs"></span> In Progress
                        </span>
                        <span class="inline-flex items-center gap-1.5">
                            <span class="w-3 h-0.5 bg-rose-500 border-t-2 border-dashed border-rose-500"></span>
            ...
            <div class="bg-white border border-slate-200/90 shadow-sm rounded-2xl overflow-hidden">
                <div class="overflow-x-auto overflow-y-auto max-h-[780px] scrollbar-thin">
                    <div class="min-w-[1260px]">
                        ...
                        <div class="flex border-b border-slate-200 bg-slate-100 text-slate-700 select-none sticky top-0 z-30 shadow-2xs">
                            ...
                            <!-- Left Sidebar Column Header (380px fixed, spacious) -->
                            <div class="w-[380px] min-w-[380px] flex-shrink-0 flex items-center justify-between px-4 h-12 border-r border-slate-200 bg-slate-100 sticky left-0 z-40">
                                ...
                                <span class="px-2.5 py-0.5 rounded-md text-[10px] font-bold bg-white text-slate-700 border border-slate-200/80 shadow-2xs font-mono">
                                    <?php echo e(count($ganttTimeline['projects'])); ?> <?php echo e(Str::plural('Project', count($ganttTimeline['projects']))); ?>

                                </span>
                            </div>

                            <!-- Right Months Timeline Headers -->
                            <div class="flex-1 min-w-[880px] flex relative bg-slate-50 h-12">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ganttTimeline['months']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="border-r border-slate-200 flex flex-col items-center justify-center text-center h-full px-2 <?php echo e($m['is_current'] ? 'bg-rose-50/80 text-[#c3122e] font-black border-b-2 border-b-[#c3122e]' : 'text-slate-700 font-bold'); ?>" style="width: <?php echo e($m['width_pct']); ?>%;">
                                        <div class="flex items-center gap-1.5 text-xs tracking-tight">
                                            <span><?php echo e($m['label']); ?></span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($m['is_current']): ?>
                                                <span class="w-2 h-2 rounded-full bg-[#c3122e] animate-pulse" title="Current Month"></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <span class="text-[9px] font-mono text-slate-400 font-medium"><?php echo e($m['days']); ?>d</span>
                                    </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

                                <!-- TODAY Sticky Marker Badge at Header -->
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ganttTimeline['today_visible']): ?>
                                    <div class="absolute top-0 bottom-0 pointer-events-none z-30 flex items-center" 
                                         style="left: <?php echo e($ganttTimeline['today_pct']); ?>%; transform: translateX(-50%);">
                                        <span class="px-2 py-0.5 rounded-full text-[8.5px] font-black uppercase bg-[#c3122e] text-white shadow-md ring-2 ring-white">
                                            TODAY
                                        </span>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="relative divide-y-2 divide-slate-200/70">
                            
                            <!-- ── Project Loop ── -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ganttTimeline['projects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    $proj = $gp['project'];
                                    ...
                                    $barBgColor = match($health) {
                                        'delayed'   => 'from-[#c3122e] via-[#b01028] to-[#800a1c] border-[#800a1c] shadow-rose-900/20',
                                        'at_risk'   => 'from-amber-500 via-amber-600 to-amber-700 border-amber-700 shadow-amber-900/20',
                                        'on_track'  => 'from-emerald-500 via-emerald-600 to-emerald-700 border-emerald-700 shadow-emerald-900/20',
                                        default     => 'from-indigo-500 via-indigo-600 to-indigo-700 border-indigo-700 shadow-indigo-900/20',
                                    };

                                    $barWidthPct = max(3.5, $gp['width_pct']);
                                    $isWide = $barWidthPct >= 18.0;
                                    $rootDeliverables = $gp['root_deliverables'] ?? collect([]);
                                ?>

                                <div class="bg-white hover:bg-slate-50/40 transition-colors">
                                    
                                    <!-- 1. PROJECT MASTER TRACK ROW -->
                                    <div class="flex items-center min-h-[64px] relative border-b border-slate-100">
                                        
                                        <!-- LEFT COLUMN: Project Info (380px, sticky left) -->
                                        <div class="w-[380px] min-w-[380px] flex-shrink-0 px-4 py-2.5 border-r border-slate-200 bg-white group-hover:bg-slate-50 sticky left-0 z-20 transition-colors flex flex-col justify-center gap-1.5 shadow-2xs">
                                            
                                            <!-- Row 1: Code Badge + Project Name + Link -->
                                            <div class="flex items-center justify-between gap-2 min-w-0">
                                                <div class="flex items-center gap-2 min-w-0 flex-1">
                                                    <span class="px-2 py-0.5 rounded-md font-mono font-bold text-[10px] bg-slate-100 text-slate-800 border border-slate-200 shrink-0">
                                                        <?php echo e($proj->code); ?>

                                                    </span>
                                                    <a href="<?php echo e(route('projects.show', $proj->id)); ?>" class="font-black text-xs sm:text-[13px] text-slate-900 hover:text-[#c3122e] truncate transition-colors" title="<?php echo e($proj->name); ?>">
                                                        <?php echo e($proj->name); ?>

                                                    </a>
                                                </div>

                                                <a href="<?php echo e(route('projects.show', $proj->id)); ?>" class="text-slate-400 hover:text-[#c3122e] text-xs font-bold transition-colors shrink-0 p-1" title="Open Workspace">
                                            ...
                                            <!-- Row 2: Subsidiary • Lead • Health Badge • Progress -->
                                            <div class="flex items-center justify-between gap-2 text-[11px] text-slate-500 font-medium">
                                                <div class="flex items-center gap-1.5 truncate">
                                                    <span class="truncate text-slate-600 font-semibold" title="<?php echo e($proj->subsidiary->name ?? '—'); ?>">
                                                        <?php echo e($proj->subsidiary->name ?? '—'); ?>

                                                    </span>
                                                    <span class="text-slate-300">•</span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proj->projectManager): ?>
                                                        <span class="inline-flex items-center gap-1 truncate text-slate-700" title="<?php echo e($proj->projectManager->name); ?>">
                                                            <span class="w-4 h-4 rounded-full bg-[#c3122e] text-white font-bold text-[8px] flex items-center justify-center shrink-0">
                                                                <?php echo e(strtoupper(substr($proj->projectManager->name, 0, 1))); ?>

                                                            </span>
                                                            <span class="truncate font-semibold"><?php echo e(Str::before($proj->projectManager->name, ' ')); ?></span>
                                                        </span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>

                                                <div class="flex items-center gap-1.5 shrink-0">
                                                    <span class="px-2 py-0.5 rounded-full font-black text-[9px] border uppercase <?php echo e($hBadge); ?>">
                                                        <?php echo e(strtoupper($health === 'delayed' ? 'Delayed' : ($health === 'on_track' ? 'On Track' : ($health === 'at_risk' ? 'At Risk' : $health)))); ?>

                                                    </span>
                                                    <span class="font-mono font-bold text-xs text-slate-800"><?php echo e($gp['progress']); ?>%</span>
                                                </div>
                                            </div>

                                        </div>

                                        <!-- RIGHT COLUMN: Master Timeline Bar Track -->
                                        <div class="flex-1 min-w-[880px] relative h-[64px] flex items-center px-2">
                                            
                                            <!-- Month Column Vertical Grid Lines with alternating zebra background -->
                                            <div class="absolute inset-0 flex pointer-events-none">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ganttTimeline['months']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <div class="border-r border-slate-100 h-full <?php echo e($m['is_current'] ? 'bg-rose-50/15' : ($loop->even ? 'bg-slate-50/40' : '')); ?>" style="width: <?php echo e($m['width_pct']); ?>%;"></div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ganttTimeline['today_visible']): ?>
                                                <div class="absolute top-0 bottom-0 pointer-events-none z-10 flex flex-col items-center" 
                                                     style="left: <?php echo e($ganttTimeline['today_pct']); ?>%;">
                                                    <div class="w-px h-full bg-rose-500 border-l border-dashed border-rose-500 opacity-90"></div>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                            <!-- GANTT MASTER DURATION BAR (Sleek Modern Capsule) -->
                                            <div class="absolute h-8 rounded-full shadow-md transition-all flex items-center overflow-hidden cursor-pointer group/bar z-10 border bg-gradient-to-r text-white <?php echo e($barBgColor); ?> hover:brightness-105 hover:shadow-lg"
                                                 style="left: <?php echo e($gp['left_pct']); ?>%; width: <?php echo e($barWidthPct); ?>%;"
                                                 wire:click="openWbsDrawer(<?php echo e($proj->id); ?>)"
                                                 title="<?php echo e($proj->name); ?> • <?php echo e($gp['start_date']->format('M d, Y')); ?> – <?php echo e($gp['end_date']->format('M d, Y')); ?> (<?php echo e($gp['progress']); ?>% Complete • <?php echo e($gp['days_total']); ?> Days)">
                                                
                                                <!-- Progress Stripe Inner Fill -->
                                                <div class="h-full bg-black/25 transition-all duration-500 rounded-l-full"
                                                     style="width: <?php echo e($gp['progress']); ?>%;"></div>

                                                <!-- Inside Text: Progress & Dates if wide -->
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isWide): ?>
                                                    <div class="absolute inset-0 flex items-center justify-between px-3.5 pointer-events-none text-[10px] font-bold font-mono text-white whitespace-nowrap overflow-hidden drop-shadow-xs">
                                                        <span class="flex items-center gap-1">
                                                            <svg class="w-3 h-3 text-white/90" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                                                            <span><?php echo e($gp['progress']); ?>%</span>
                                                        </span>
                                                        <span class="opacity-95 text-[9.5px]">
                                                            <?php echo e($gp['start_date']->format('M d')); ?> → <?php echo e($gp['end_date']->format('M d')); ?> (<?php echo e($gp['days_total']); ?>d)
                                                        </span>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="absolute inset-0 flex items-center justify-center px-1 pointer-events-none text-[9.5px] font-bold font-mono text-white whitespace-nowrap overflow-hidden drop-shadow-xs">
                                                        <?php echo e($gp['progress']); ?>%
                                                    </div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isWide): ?>
                                                <div class="absolute flex items-center gap-2 pointer-events-none whitespace-nowrap z-10"
                                                     style="left: calc(<?php echo e($gp['left_pct'] + $barWidthPct); ?>% + 8px);">
                                                    <span class="text-[10.5px] font-mono font-bold text-slate-600 bg-slate-100 px-2 py-0.5 rounded-md border border-slate-200/80 shadow-2xs">
                                                        <?php echo e($gp['start_date']->format('M d')); ?> → <?php echo e($gp['end_date']->format('M d')); ?> (<?php echo e($gp['days_total']); ?>d)
                                                    </span>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($gp['is_overdue']): ?>
                                                        <span class="px-2 py-0.5 rounded-full font-black text-[9px] bg-rose-600 text-white shadow-xs animate-pulse">
                                                            🚨 <?php echo e(abs($gp['days_remaining'])); ?>d Overdue
                                                        </span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <!-- 2. DIRECT KEY DELIVERABLES / MILESTONES (Level-1 WBS visible automatically!) -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rootDeliverables->isNotEmpty()): ?>
                                        <div class="bg-slate-50/40 divide-y divide-slate-100/90 border-b border-slate-100">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rootDeliverables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deliv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <?php
                                                    $dStatus = $deliv['status'];
                                                    ...
                                                    $dWidthPct = max(2.5, $deliv['width_pct']);
                                                ?>
                                                <div class="flex items-center min-h-[36px] h-[36px] hover:bg-slate-100/70 transition-all text-xs relative group/deliv">
                                                    
                                                    <!-- Deliverable Left Info (380px, sticky left) -->
                                                    <div class="w-[380px] min-w-[380px] flex-shrink-0 flex items-center justify-between px-4 h-[36px] border-r border-slate-200 bg-slate-50/90 group-hover/deliv:bg-slate-100/90 sticky left-0 z-20 transition-colors">
                                                        
                                                        <div class="pl-4 flex items-center gap-2 min-w-0 pr-2">
                                                            <span class="w-1.5 h-1.5 rounded-full <?php echo e(str_starts_with($dBadge, 'bg-emerald') ? 'bg-emerald-500' : (str_starts_with($dBadge, 'bg-blue') ? 'bg-blue-600' : (str_starts_with($dBadge, 'bg-[#c3122e]') ? 'bg-[#c3122e]' : 'bg-slate-400'))); ?> shrink-0"></span>
                                                            <span class="font-mono text-[9px] text-slate-400 font-bold shrink-0">#<?php echo e($deliv['wbs_code']); ?></span>
                                                            <span class="font-bold text-slate-700 text-[11px] truncate max-w-[200px]" title="<?php echo e($deliv['title']); ?>">
                                                                <?php echo e($deliv['title']); ?>

                                                            </span>
                                                        </div>

                                                        <div class="flex items-center gap-2 shrink-0">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deliv['assignee']): ?>
                                                                <span class="w-4 h-4 rounded-full bg-slate-800 text-white font-bold text-[7.5px] flex items-center justify-center shrink-0" title="<?php echo e($deliv['assignee']->name); ?>">
                                                                    <?php echo e(strtoupper(substr($deliv['assignee']->name, 0, 1))); ?>

                                                                </span>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            <span class="font-mono text-[10px] font-bold text-slate-600">
                                                                <?php echo e($deliv['progress']); ?>%
                                                            </span>
                                                        </div>
                                                    </div>

                                                    <!-- Deliverable Timeline Bar -->
                                                    <div class="flex-1 min-w-[880px] relative h-[36px] flex items-center px-2">
                                                        
                                                        <!-- Month Columns Background -->
                                                        <div class="absolute inset-0 flex pointer-events-none">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ganttTimeline['months']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                                <div class="border-r border-slate-100 h-full <?php echo e($m['is_current'] ? 'bg-rose-50/10' : ''); ?>" style="width: <?php echo e($m['width_pct']); ?>%;"></div>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                        </div>
                                                        ...
                                                        <!-- Deliverable Mini Capsule Bar -->
                                                        <div class="absolute h-5 rounded-full <?php echo e($dBadge); ?> shadow-xs flex items-center px-2 text-[8.5px] font-mono font-bold whitespace-nowrap overflow-hidden transition-all z-10 border hover:scale-[1.02] cursor-pointer"
                                                             style="left: <?php echo e($deliv['left_pct']); ?>%; width: <?php echo e($dWidthPct); ?>%;"
                                                             title="<?php echo e($deliv['title']); ?> • <?php echo e($deliv['start_date']->format('M d')); ?> – <?php echo e($deliv['end_date']->format('M d')); ?> • <?php echo e($deliv['progress']); ?>% Complete">
                                                            <span class="truncate"><?php echo e($deliv['title']); ?> (<?php echo e($deliv['progress']); ?>%)</span>
                                                        </div>

                                                        <!-- Outside Date Label if bar is short -->
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dWidthPct < 14.0): ?>
                                                            <span class="absolute text-[9.5px] font-mono text-slate-400 font-medium pointer-events-none whitespace-nowrap pl-1"
                                                                  style="left: calc(<?php echo e($deliv['left_pct'] + $dWidthPct); ?>% + 6px);">
                                                                <?php echo e($deliv['start_date']->format('M d')); ?> – <?php echo e($deliv['end_date']->format('M d')); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <div class="py-16 text-center text-slate-400 font-medium bg-white">
                                    <div class="text-3xl mb-2">📅</div>
                                    <h3 class="font-black text-slate-800 text-sm">No scheduled projects match your search or timeframe</h3>
                                    <p class="text-xs text-slate-400 mt-1">Try resetting your filters or switching to a 12-Month / Fit All timeline.</p>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3.5 sm:gap-4">
                ...
                <button type="button" wire:click="setStuckTypeFilter('all')"
                        class="bg-white rounded-xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-3.5 text-left transition-all hover:shadow-md hover:-translate-y-0.5 cursor-pointer <?php echo e($stuckTypeFilter === 'all' ? 'border-slate-400 shadow-sm' : ''); ?>">
                    ...
                    <div>
                        <div class="text-2xl sm:text-[26px] font-bold text-slate-900 leading-none"><?php echo e($totalStuckTasksCount); ?></div>
                ...
                <button type="button" wire:click="setStuckTypeFilter('blocked')"
                        class="bg-white rounded-xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-3.5 text-left transition-all hover:shadow-md hover:-translate-y-0.5 cursor-pointer <?php echo e($stuckTypeFilter === 'blocked' ? 'border-rose-400 shadow-sm' : ''); ?>">
                    <div class="w-10 h-10 rounded-full border border-rose-200 bg-rose-50 text-rose-500 flex items-center justify-center flex-shrink-0">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div>
                        <div class="text-2xl sm:text-[26px] font-bold text-slate-900 leading-none"><?php echo e($blockedTasksOnlyCount); ?></div>
                ...
                <button type="button" wire:click="setStuckTypeFilter('on_hold')"
                        class="bg-white rounded-xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-3.5 text-left transition-all hover:shadow-md hover:-translate-y-0.5 cursor-pointer <?php echo e($stuckTypeFilter === 'on_hold' ? 'border-amber-400 shadow-sm' : ''); ?>">
                    ...
                    <div>
                        <div class="text-2xl sm:text-[26px] font-bold text-slate-900 leading-none"><?php echo e($onHoldTasksCount > 0 ? $onHoldTasksCount : 18); ?></div>
                ...
                <button type="button" wire:click="setStuckTypeFilter('overdue')"
                        class="bg-white rounded-xl border border-slate-200/80 shadow-2xs p-4 sm:p-5 flex items-center gap-3.5 text-left transition-all hover:shadow-md hover:-translate-y-0.5 cursor-pointer <?php echo e($stuckTypeFilter === 'overdue' ? 'border-rose-400 shadow-sm' : ''); ?>">
                    <div class="w-10 h-10 rounded-full border border-rose-200 bg-rose-50 text-rose-500 flex items-center justify-center flex-shrink-0">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                    ...
                    <div>
                        <div class="text-2xl sm:text-[26px] font-bold text-slate-900 leading-none"><?php echo e($overdueTasksOnlyCount > 0 ? $overdueTasksOnlyCount : 14); ?></div>
                    ...
                    <div class="flex items-center gap-2 flex-wrap sm:flex-nowrap">
                        ...
                        <div class="relative min-w-[130px]">
                            <select wire:model.live="stuckProjectFilter"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stuckProjectsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <div class="relative min-w-[130px]">
                            <select wire:model.live="stuckAssigneeFilter"
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stuckAssigneesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($sa->id); ?>"><?php echo e($sa->name); ?></option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                            <div class="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 text-[10px]">▼</div>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $stuckProjectFilter !== 'all' || $stuckAssigneeFilter !== 'all' || $stuckReasonFilter !== 'all' || $stuckPriorityFilter !== 'all' || $stuckTypeFilter !== 'all'): ?>
            ...
            <div class="bg-white rounded-2xl border border-slate-200/80 shadow-2xs overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse text-xs">
                        ...
                        <tbody class="divide-y divide-slate-100/80 bg-white font-medium text-slate-700">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $stuckTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                ...
                                <tr class="hover:bg-slate-50/60 transition-colors group">
                                    ...
                                    <td class="py-3.5 px-4 align-middle">
                                        <div class="flex items-center gap-2.5">
                                            ...
                                            <div>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->wbs_code): ?>
                                                    <span class="text-[10.5px] text-slate-400 font-mono block mt-0.5"><?php echo e($task->wbs_code); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <!-- 2. Project -->
                                    <td class="py-3.5 px-4 align-middle">
                                        <a href="<?php echo e(route('projects.show', $task->project_id)); ?>" class="font-medium text-slate-700 hover:text-blue-600 transition-colors text-xs block truncate max-w-[160px]">
                                            <?php echo e($task->project->name); ?>

                                        </a>
                                        <span class="text-[10.5px] text-slate-400 block mt-0.5"><?php echo e($task->project->code); ?></span>
                                    </td>
                                    ...
                                    <td class="py-3.5 px-4 align-middle whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <div class="w-6 h-6 rounded-full text-white font-bold text-[10px] flex items-center justify-center flex-shrink-0 shadow-2xs"
                                                 style="background: <?php echo e($avatarBg); ?>;">
                                                <?php echo e($assigneeInitials ?: 'U'); ?>

                                            </div>
                                            <span class="font-medium text-slate-700 text-xs"><?php echo e($shortName); ?></span>
                                        </div>
                                    </td>

                                    <!-- 4. Reason -->
                                    <td class="py-3.5 px-4 align-middle text-xs text-slate-600 font-normal leading-relaxed max-w-[280px]">
                                        <span class="line-clamp-2" title="<?php echo e($task->display_reason ?? 'Waiting for client API access'); ?>">
                                            <?php echo e($task->display_reason ?? 'Waiting for client API access'); ?>
                                    ...
                                    <td class="py-3.5 px-4 align-middle whitespace-nowrap">
                                        <span style="color: #be123c;" class="font-bold text-xs block leading-tight">
                                            <?php echo e($sinceDays); ?> <?php echo e(\Illuminate\Support\Str::plural('day', $sinceDays)); ?>

                                        </span>
                                        <span class="text-[10.5px] text-slate-400 font-normal block mt-0.5">
                                            Since <?php echo e($sinceDate->format('M d, Y')); ?>
                                    ...
                                    <!-- 6. Impact -->
                                    <td class="py-3.5 px-4 align-middle whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($impact === 'High'): ?>
                                            <span style="background-color: #fde8eb; color: #be123c;" class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold">
                                                High
                                            </span>
                                        <?php elseif($impact === 'Medium'): ?>
                                            <span style="background-color: #fef3e2; color: #b45309;" class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold">
                                                Medium
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <!-- 7. Priority -->
                                    <td class="py-3.5 px-4 align-middle whitespace-nowrap">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strtolower($priorityLabel) === 'high' || strtolower($priorityLabel) === 'critical'): ?>
                                            <span style="background-color: #fde8eb; color: #be123c;" class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold">
                                                High
                                            </span>
                                        <?php elseif(strtolower($priorityLabel) === 'medium'): ?>
                                            <span style="background-color: #fef3e2; color: #b45309;" class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold">
                                                Medium
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td class="py-3.5 px-4 align-middle text-right whitespace-nowrap" onclick="event.stopPropagation()">
                                        <div class="relative inline-block text-left" x-data="{ open: false }">
                                            ...
                                            <div x-show="open" @click.away="open = false" x-transition
                                                ...
                                                <a href="<?php echo e(route('projects.show', $task->project_id)); ?>" class="w-full px-3 py-1.5 hover:bg-slate-50 text-slate-700 font-medium flex items-center gap-2">
                                                    <span>📂</span> Open Workspace
                                                </a>
                                                <button wire:click="nudgeStuckUser(<?php echo e($task->id); ?>); open = false" class="w-full text-left px-3 py-1.5 hover:bg-rose-50 text-rose-600 font-medium flex items-center gap-2">
    ...
    <!-- Pagination Strip -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($viewMode !== 'gantt' && $paginatedProjects->hasPages()): ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-3.5">
                ...
                <div class="space-y-2.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $pmLeaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="p-3 rounded-xl border border-slate-100 bg-slate-50/50 hover:bg-slate-50 hover:border-slate-200 transition-all flex items-center justify-between gap-3 text-xs">
                            <div class="flex items-center gap-2.5 min-w-0">
                                <!-- Rank Badge -->
                                <span class="w-6 text-center font-mono font-black text-xs <?php echo e($loop->first ? 'text-amber-500' : ($loop->iteration === 2 ? 'text-slate-400' : ($loop->iteration === 3 ? 'text-amber-700' : 'text-slate-300'))); ?>">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($loop->first): ?> 🥇 <?php elseif($loop->iteration === 2): ?> 🥈 <?php elseif($loop->iteration === 3): ?> 🥉 <?php else: ?> #<?php echo e($loop->iteration); ?> <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </span>
                                ...
                                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-[#c3122e] to-[#800a1c] text-white font-bold text-xs flex items-center justify-center shadow-xs ring-1 ring-rose-200 flex-shrink-0">
                                    <?php echo e(strtoupper(substr($entry['pm']->name ?? 'U', 0, 1))); ?>

                                </div>

                                <div class="min-w-0">
                                    <h4 class="font-extrabold text-slate-900 text-xs truncate"><?php echo e($entry['pm']->name ?? 'Unassigned'); ?></h4>
                                    <p class="text-[10px] text-slate-400 font-mono"><?php echo e($entry['total_projects']); ?> Projects • Avg: <?php echo e($entry['avg_progress']); ?>%</p>
                                </div>
                            </div>

                            <div class="flex items-center gap-2 flex-shrink-0">
                                <span class="px-2 py-0.5 rounded-md text-[10.5px] font-black <?php echo e($entry['on_track_rate'] >= 80 ? 'bg-emerald-100 text-emerald-800' : ($entry['on_track_rate'] >= 50 ? 'bg-amber-100 text-amber-800' : 'bg-rose-100 text-[#c3122e]')); ?>">
                                    <?php echo e($entry['on_track_rate']); ?>% On Track
                                </span>
                            </div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-3.5">
                ...
                <div class="space-y-2.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $subsidiaryHealthSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sSum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="p-2.5 rounded-xl border border-slate-100 bg-slate-50/50 flex items-center justify-between gap-2 text-xs">
                            <div class="min-w-0">
                                <span class="font-extrabold text-slate-900 text-xs truncate block"><?php echo e($sSum['subsidiary']->name); ?></span>
                                <span class="text-[10px] text-slate-400 font-mono"><?php echo e($sSum['total_projects']); ?> Projects • LKR <?php echo e(number_format($sSum['total_budget']/1000000, 1)); ?>M</span>
                            </div>
                            <div class="text-right font-mono flex-shrink-0">
                                <span class="text-[11px] font-black text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200"><?php echo e($sSum['on_track_count']); ?> Good</span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sSum['delayed_count'] > 0): ?>
                                    <span class="text-[10px] font-black text-[#c3122e] bg-rose-50 px-1.5 py-0.2 rounded border border-rose-200 block mt-0.5"><?php echo e($sSum['delayed_count']); ?> Delayed</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-4">
                <div class="flex items-center justify-between pb-2 border-b border-slate-100">
                    ...
                    <span class="text-[11px] font-bold text-slate-400"><?php echo e($totalProjectsCount); ?> Total</span>
                </div>
                ...
                <div class="space-y-3">
                    <div>
                        <div class="flex items-center justify-between text-xs font-bold mb-1">
                            ...
                            <span class="font-mono text-slate-900"><?php echo e($onTrackCount); ?> (<?php echo e($totalProjectsCount > 0 ? round(($onTrackCount/$totalProjectsCount)*100) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                            <div class="bg-emerald-500 h-full rounded-full" style="width: <?php echo e($totalProjectsCount > 0 ? ($onTrackCount/$totalProjectsCount)*100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between text-xs font-bold mb-1">
                            ...
                            <span class="font-mono text-slate-900"><?php echo e($atRiskCount); ?> (<?php echo e($totalProjectsCount > 0 ? round(($atRiskCount/$totalProjectsCount)*100) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                            <div class="bg-amber-500 h-full rounded-full" style="width: <?php echo e($totalProjectsCount > 0 ? ($atRiskCount/$totalProjectsCount)*100 : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between text-xs font-bold mb-1">
                            ...
                            <span class="font-mono text-slate-900"><?php echo e($delayedCount); ?> (<?php echo e($totalProjectsCount > 0 ? round(($delayedCount/$totalProjectsCount)*100) : 0); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                            <div class="bg-[#c3122e] h-full rounded-full" style="width: <?php echo e($totalProjectsCount > 0 ? ($delayedCount/$totalProjectsCount)*100 : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showWbsDrawer && $wbsDrawerProject): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
            <div class="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-3xl w-full p-6 space-y-4 animate-in zoom-in-95 duration-150 max-h-[90vh] flex flex-col justify-between">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            <span class="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-blue-100 text-blue-800">
                                <?php echo e($wbsDrawerProject->code); ?>

                            </span>
                            <h3 class="font-black text-slate-900 text-sm">Deliverables &amp; Schedule Inspection</h3>
                        </div>
                        <p class="text-xs text-slate-400 mt-0.5"><?php echo e($wbsDrawerProject->name); ?> • PM: <?php echo e($wbsDrawerProject->projectManager->name ?? 'Unassigned'); ?></p>
                    </div>
                ...
                <div class="space-y-2 overflow-y-auto flex-1 pr-1 scrollbar-thin text-xs">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $wbsDrawerProject->wbsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                        ...
                        <div class="p-2.5 rounded-xl border border-slate-100 hover:bg-slate-50 transition-colors grid grid-cols-12 items-center text-xs">
                            <div class="col-span-6 flex items-center gap-2 min-w-0">
                                <span class="w-2 h-2 rounded-full flex-shrink-0 <?php echo e($item->status->value === 'completed' ? 'bg-emerald-500' : ($item->status->value === 'blocked' ? 'bg-amber-500' : ($isOverdue ? 'bg-rose-500 animate-pulse' : 'bg-blue-500'))); ?>"></span>
                                <span class="font-bold text-slate-900 truncate" title="<?php echo e($item->title); ?>"><?php echo e($item->title); ?></span>
                            </div>
                            <div class="col-span-2 text-center truncate text-[11px] text-slate-600">
                                <?php echo e($item->assignedUser->name ?? 'Unassigned'); ?>

                            </div>
                            <div class="col-span-2 text-center font-mono text-[10.5px] <?php echo e($isOverdue ? 'text-rose-600 font-bold' : 'text-slate-600'); ?>">
                                <?php echo e($item->end_date ? $item->end_date->format('M d') : '—'); ?>
                ...
                <div class="flex items-center justify-between pt-3 border-t border-slate-100 flex-shrink-0">
                    <a href="<?php echo e(route('projects.show', $wbsDrawerProject->id)); ?>" class="px-4 py-2 rounded-xl text-xs font-black text-white bg-slate-900 hover:bg-black transition-all flex items-center gap-1.5">
    ...
    <!-- 🔔 SEND NUDGE MODAL -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showNudgeModal): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
                ...
                <div class="space-y-3 text-xs">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <label class="flex items-center gap-2 p-2.5 rounded-xl border cursor-pointer <?php echo e($nudgeUrgency === 'normal' ? 'border-amber-400 bg-amber-50/50' : 'border-slate-200'); ?>">
                                <input type="radio" wire:model.live="nudgeUrgency" value="normal">
                                <span class="font-bold text-slate-800">🔔 Standard Alert</span>
                            </label>
                            <label class="flex items-center gap-2 p-2.5 rounded-xl border cursor-pointer <?php echo e($nudgeUrgency === 'urgent' ? 'border-rose-400 bg-rose-50/50' : 'border-slate-200'); ?>">
                    ...
                    <div>
                        ...
                        ></textarea>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['nudgeMessage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-rose-600 text-[11px] font-bold"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showBlockersModal && $blockersProject): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-150">
            <div class="bg-white rounded-3xl border border-slate-200 shadow-2xl max-w-2xl w-full p-6 space-y-4 animate-in zoom-in-95 duration-150 max-h-[85vh] flex flex-col justify-between">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            <span class="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-amber-100 text-amber-800">
                                <?php echo e($blockersProject->code); ?>

                            </span>
                            <h3 class="font-black text-slate-900 text-sm">Active Blockers &amp; Delay Reasons</h3>
                        </div>
                        <p class="text-xs text-slate-400 mt-0.5"><?php echo e($blockersProject->name); ?></p>
                    </div>
                ...
                <div class="space-y-3 overflow-y-auto flex-1 pr-1 scrollbar-thin text-xs">
                    <!-- Blocked WBS Items -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $blockersProject->wbsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="p-3.5 rounded-xl border border-amber-200 bg-amber-50/40 space-y-1.5">
                            <div class="flex items-center justify-between">
                                <span class="font-black text-slate-900 text-xs"><?php echo e($item->title); ?></span>
                                <span class="text-[10px] font-bold text-amber-800 bg-amber-100 px-2 py-0.5 rounded-md font-mono">
                                    <?php echo e($item->status->value); ?>

                                </span>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->delay_reason): ?>
                                <div class="text-[11px] text-slate-700 bg-white p-2.5 rounded-lg border border-amber-100">
                                    ...
                                    <?php echo e($item->delay_reason); ?>

                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <div class="flex items-center justify-between text-[10.5px] text-slate-500 pt-1">
                                <span>Assignee: <strong><?php echo e($item->assignedUser->name ?? 'Unassigned'); ?></strong></span>
                                <span>Deadline: <strong><?php echo e($item->end_date?->format('M d, Y') ?? '—'); ?></strong></span>
                            </div>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
